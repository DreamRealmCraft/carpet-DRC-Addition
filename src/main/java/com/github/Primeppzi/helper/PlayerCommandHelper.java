...
public class PlayerCommandHelper {
    ...
    private static boolean cantManipulate(CommandContext<ServerCommandSource> context)
    {
        ...
        try
        {
            sendingPlayer = context.getSource().getPlayerOrThrow();
        }
    ...
    private static <T> T tryGetArg(PlayerCommandHelper.SupplierWithCommandSyntaxException<T> a, PlayerCommandHelper.SupplierWithCommandSyntaxException<T> b) throws CommandSyntaxException
    {
        try
        {
            return a.get();
